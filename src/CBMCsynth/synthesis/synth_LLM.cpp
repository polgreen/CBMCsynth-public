...
void llm_syntht::top_down_enumerate()
{
...
solutiont llm_syntht::get_solution() const
{
  return last_solution;
}

void llm_syntht::set_program_size(std::size_t size)
{
  program_size = size;
}

void llm_syntht::add_counterexample(const counterexamplet &cex)
{
  counterexamples.push_back(cex);
}


void llm_syntht::create_distributions()
{
...
llm_syntht::resultt llm_syntht::operator()(std::size_t iteration)
{
  iter = iteration;
